...
import survival1sm.fakerpojo.domain.NoAllArgsConstructorTestDomain;
...
import survival1sm.fakerpojo.domain.UninimplementedFieldAnnotationTestDomain;
...
class DataBuilderTest {
  ...
  void build_class_domain_returns_expected_types() throws Exception {
    ClassTestDomain test = Builder.fromPojo(ClassTestDomain.class)
        .getFirst()
        .build();
  ...
  void build_list_class_domain_returns_expected_lists() throws Exception {
    ListClassTestDomain test = Builder
  ...
  void build_set_class_domain_returns_expected_sets() throws Exception {
    SetClassTestDomain test = Builder
  ...
  void build_string_set_map_class_domain_returns_expected_maps() throws Exception {
    MapStringSetTestDomain test = Builder
  ...
  void build_string_list_map_class_domain_returns_expected_maps() throws Exception {
    MapStringListTestDomain test = Builder
  ...
  void build_string_domain_map_class_domain_returns_expected_map() throws Exception {
    MapStringDomainTestDomain test = Builder
  ...
  void build_class_domain_with_unique_on_key_returns_expected_unique_domain() throws Exception {
    ClassTestDomain boolOne = Builder.fromPojo(ClassTestDomain.class)
        .getFirst()
        .withUniqueOnKey("testBoolean")
        .build();

    ClassTestDomain boolTwo = Builder.fromPojo(ClassTestDomain.class)
        .getFirst()
        .withUniqueOnKey("testBoolean")
        .build();
  ...
  void build_record_domain_returns_expected_types() throws Exception {
    RecordTestDomain test = Builder.fromPojo(RecordTestDomain.class)
        .getFirst()
        .build();
  ...
  void build_list_domain_domain_returns_expected_list() throws Exception {
    ListDomainTestDomain test = Builder.fromPojo(ListDomainTestDomain.class).getFirst().build();
  ...
  void build_list_record_domain_returns_expected_list() throws Exception {
    ListRecordTestDomain test = Builder.fromPojo(ListRecordTestDomain.class).getFirst().build();
  ...
  void build_list_map_domain_returns_expected_list() throws Exception {
    ListMapTestDomain test = Builder.fromPojo(ListMapTestDomain.class).getFirst().build();
  ...
  void build_custom_field_annotation_class_domain_returns_expected_domain() throws Exception {
    FieldAnnotationTestDomain test = Builder.fromPojo(FieldAnnotationTestDomain.class).getFirst().build();
  ...
  void build_custom_value_generator_returns_expected_values() throws Exception {
    ...
    assertEquals(NanoPrefix.type, NanoIdService.getPrefixFromValue(test.getTestNanoId().substring(0, 3)));
    assertEquals(NanoPrefix.project, NanoIdService.getPrefixFromValue(test.getTestNanoIdList().get(0).substring(0, 3)));
  }
