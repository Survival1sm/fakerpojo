...
import io.github.survival1sm.fakerpojo.domain.ObjectTestDomain;
...
class DataBuilderTest {
  ...
  void build_class_domain_returns_expected_types() throws Exception {
    ClassTestDomain test = FakerPojo.Builder.fromPojo(ClassTestDomain.class).getFirst().build();
  ...
  void build_class_domain_returns_expected_formats() throws Exception {
    ...
    assertTrue(
        test.getTestInteger() >= fieldAnnotation.getMin()
            && test.getTestInteger() <= fieldAnnotation.getMax());
    assertTrue(Stream.of(true, false).anyMatch(bool -> bool.equals(test.getTestBoolean())));
    assertEquals(10, test.getTestString().length());
    assertTrue(
        test.getTestDate().getHours() == 0
            && test.getTestDate().getMinutes() == 0
            && test.getTestDate().getSeconds() == 0);
    assertEquals(10, test.getTestLocalDate().toString().length());
    assertTrue(
        test.getTestLocalDateTime().getHour() > 0
            || test.getTestLocalDateTime().getMinute() > 0
  ...
  void build_list_class_domain_returns_expected_lists() throws Exception {
    ListClassTestDomain test =
        FakerPojo.Builder.fromPojo(ListClassTestDomain.class).getFirst().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();

    assertTrue(
        test.getTestInteger().size() == fieldAnnotation.getRecords()
            && test.getTestInteger().get(0) != null);
    assertTrue(
        test.getTestBoolean().size() == fieldAnnotation.getRecords()
            && test.getTestBoolean().get(0) != null);
    assertTrue(
        test.getTestDouble().size() == fieldAnnotation.getRecords()
            && test.getTestDouble().get(0) != null);
    assertTrue(
        test.getTestString().size() == fieldAnnotation.getRecords()
            && test.getTestString().get(0) != null);
    assertTrue(
        test.getTestDate().size() == fieldAnnotation.getRecords()
            && test.getTestDate().get(0) != null);
    assertTrue(
        test.getTestLocalDate().size() == fieldAnnotation.getRecords()
            && test.getTestLocalDate().get(0) != null);
    assertTrue(
        test.getTestLocalDateTime().size() == fieldAnnotation.getRecords()
            && test.getTestLocalDateTime().get(0) != null);
    assertTrue(
        test.getTestFloat().size() == fieldAnnotation.getRecords()
            && test.getTestFloat().get(0) != null);
    assertTrue(
        test.getTestLong().size() == fieldAnnotation.getRecords()
            && test.getTestLong().get(0) != null);
    assertTrue(
        test.getTestInstant().size() == fieldAnnotation.getRecords()
            && test.getTestInstant().get(0) != null);
    assertTrue(
        test.getTestEnum().size() == fieldAnnotation.getRecords()
            && test.getTestEnum().get(0) != null);
    assertTrue(
        test.getTestUuid().size() == fieldAnnotation.getRecords()
            && test.getTestUuid().get(0) != null);
    assertTrue(
        test.getTestDuration().size() == fieldAnnotation.getRecords()
            && test.getTestDuration().get(0) != null);
  }

  @Test
  void build_set_class_domain_returns_expected_sets() throws Exception {
    SetClassTestDomain test =
        FakerPojo.Builder.fromPojo(SetClassTestDomain.class).getFirst().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();

    assertTrue(
        test.getTestInteger().size() == fieldAnnotation.getRecords()
            && test.getTestInteger().iterator().next() != null);
    assertTrue(
        test.getTestBoolean().size() == fieldAnnotation.getRecords()
            && test.getTestBoolean().iterator().next() != null);
    assertTrue(
        test.getTestDouble().size() == fieldAnnotation.getRecords()
            && test.getTestDouble().iterator().next() != null);
    assertTrue(
        test.getTestString().size() == fieldAnnotation.getRecords()
            && test.getTestString().iterator().next() != null);
    assertTrue(
        test.getTestDate().size() == fieldAnnotation.getRecords()
            && test.getTestDate().iterator().next() != null);
    assertTrue(
        test.getTestLocalDate().size() == fieldAnnotation.getRecords()
    ...
    assertTrue(
        test.getTestFloat().size() == fieldAnnotation.getRecords()
            && test.getTestFloat().iterator().next() != null);
    assertTrue(
        test.getTestLong().size() == fieldAnnotation.getRecords()
            && test.getTestLong().iterator().next() != null);
    assertTrue(
        test.getTestInstant().size() == fieldAnnotation.getRecords()
            && test.getTestInstant().iterator().next() != null);
    assertTrue(
        test.getTestEnum().size() == fieldAnnotation.getRecords()
            && test.getTestEnum().iterator().next() != null);
    assertTrue(
        test.getTestUuid().size() == fieldAnnotation.getRecords()
            && test.getTestUuid().iterator().next() != null);
    assertTrue(
        test.getTestDuration().size() == fieldAnnotation.getRecords()
            && test.getTestDuration().iterator().next() != null);
  }

  @Test
  void build_string_set_map_class_domain_returns_expected_maps() throws Exception {
    MapStringSetTestDomain test =
        FakerPojo.Builder.fromPojo(MapStringSetTestDomain.class).getFirst().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();
  ...
  void build_string_list_map_class_domain_returns_expected_maps() throws Exception {
    MapStringListTestDomain test =
        FakerPojo.Builder.fromPojo(MapStringListTestDomain.class).getFirst().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();
  ...
  void build_string_domain_map_class_domain_returns_expected_map() throws Exception {
    MapStringDomainTestDomain test =
        FakerPojo.Builder.fromPojo(MapStringDomainTestDomain.class).getFirst().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();

    assertTrue(
        test.getTestDomainMap().size() == fieldAnnotation.getRecords()
  ...
  void build_class_domain_with_unique_on_key_returns_expected_unique_domain() throws Exception {
    ClassTestDomain boolOne =
        FakerPojo.Builder.fromPojo(ClassTestDomain.class)
            .getFirst()
            .withUniqueOnKey("testBoolean")
            .build();

    ClassTestDomain boolTwo =
        FakerPojo.Builder.fromPojo(ClassTestDomain.class)
            .getFirst()
            .withUniqueOnKey("testBoolean")
            .build();
  ...
  void build_record_domain_returns_expected_types() throws Exception {
    RecordTestDomain test = FakerPojo.Builder.fromPojo(RecordTestDomain.class).getFirst().build();
  ...
  void build_list_domain_domain_returns_expected_list() throws Exception {
    ListDomainTestDomain test =
        FakerPojo.Builder.fromPojo(ListDomainTestDomain.class).getFirst().build();

    assertTrue(
        test.getClassTestDomainList().size() == 1 && test.getClassTestDomainList().get(0) != null);
  }

  @Test
  void build_list_record_domain_returns_expected_list() throws Exception {
    ListRecordTestDomain test =
        FakerPojo.Builder.fromPojo(ListRecordTestDomain.class).getFirst().build();

    assertTrue(
        test.getRecordTestDomainList().size() == 1
            && test.getRecordTestDomainList().get(0) != null);
  }
  ...
  void build_list_map_domain_returns_expected_list() throws Exception {
    ...
    assertTrue(
        test.getMapStringDomainList().size() == 1 && test.getMapStringDomainList().get(0) != null);
  }

  @Test
  void build_custom_field_annotation_class_domain_returns_expected_domain() throws Exception {
    FieldAnnotationTestDomain test =
        FakerPojo.Builder.fromPojo(FieldAnnotationTestDomain.class).getFirst().build();
  ...
  void build_custom_value_generator_returns_expected_values() throws Exception {
    CustomValueGeneratorTestDomain test =
        FakerPojo.Builder.fromPojo(CustomValueGeneratorTestDomain.class).getFirst().build();

    assertTrue(test.getTestEmployeeNumber() >= 20 && test.getTestEmployeeNumber() <= 1200000);
    assertTrue(
        Integer.parseInt(test.getTestEmployeeNumberString()) >= 20
            && test.getTestEmployeeNumber() <= 1200000);
    Assertions.assertEquals(
        NanoPrefix.type, NanoIdService.getPrefixFromValue(test.getTestNanoId().substring(0, 3)));
    Assertions.assertEquals(
        NanoPrefix.project,
        NanoIdService.getPrefixFromValue(test.getTestNanoIdList().get(0).substring(0, 3)));
  }

  @Test
  void build_unimplemented_field_class_throws_FieldGeneratorNotImplementedException() {
    DataBuilder<UninimplementedFieldAnnotationTestDomain> test =
        FakerPojo.Builder.fromPojo(UninimplementedFieldAnnotationTestDomain.class).getFirst();
    assertThrows(FieldGeneratorNotImplementedException.class, test::build);
  }

  @Test
  void build_pojo_with_object_field_throws_FieldGeneratorNotImplementedException() {
    DataBuilder<ObjectTestDomain> test =
        FakerPojo.Builder.fromPojo(ObjectTestDomain.class).getFirst();
    assertThrows(FieldGeneratorNotImplementedException.class, test::build);
  }

  @Test
  void build_pojo_with_object_field_and_provided_value_generator_returns_expected_value()
      throws Exception {

    FakerPojo.addFieldValuesGenerator(
        Type.OBJECT, (FakerFieldProps fieldProps) -> "stringForObject");

    ObjectTestDomain objectTestDomain =
