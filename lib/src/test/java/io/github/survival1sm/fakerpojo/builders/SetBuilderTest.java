...
class SetBuilderTest {
  ...
  void build_class_domain_returns_expected_types() throws Exception {
    Set<ClassTestDomain> test = FakerPojo.Builder.fromPojo(ClassTestDomain.class).toSet().build();
  ...
  void build_class_domain_returns_expected_formats() throws Exception {
    ...
    assertTrue(
        Stream.of(true, false)
            .anyMatch(bool -> bool.equals(test.iterator().next().getTestBoolean())));
    assertEquals(10, test.iterator().next().getTestString().length());
    assertTrue(
        test.iterator().next().getTestDate().getHours() == 0
            && test.iterator().next().getTestDate().getMinutes() == 0
            && test.iterator().next().getTestDate().getSeconds() == 0);
    assertEquals(10, test.iterator().next().getTestLocalDate().toString().length());
    assertTrue(
        test.iterator().next().getTestLocalDateTime().getHour() > 0
  ...
  void build_list_class_domain_returns_expected_lists() throws Exception {
    Set<ListClassTestDomain> test =
        FakerPojo.Builder.fromPojo(ListClassTestDomain.class).toSet().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();
    ...
    assertTrue(
        test.iterator().next().getTestLocalDate().size() == fieldAnnotation.getRecords()
  ...
  void build_set_class_domain_returns_expected_sets() throws Exception {
    Set<SetClassTestDomain> test =
        FakerPojo.Builder.fromPojo(SetClassTestDomain.class).toSet().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();
  ...
  void build_string_set_map_class_domain_returns_expected_maps() throws Exception {
    Set<MapStringSetTestDomain> test =
        FakerPojo.Builder.fromPojo(MapStringSetTestDomain.class).toSet().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();

    assertTrue(
        test.iterator().next().getTestInteger().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestInteger().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestBoolean().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestBoolean().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestDouble().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestDouble().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestString().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestString().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestDate().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestDate().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestLocalDate().size() == fieldAnnotation.getRecords()
            && test.iterator()
    ...
    assertTrue(
        test.iterator().next().getTestFloat().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestFloat().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestLong().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestLong().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestInstant().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestInstant().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestEnum().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestEnum().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestUuid().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestUuid().values().iterator().next().iterator().next()
                != null);
    assertTrue(
        test.iterator().next().getTestDuration().size() == fieldAnnotation.getRecords()
            && test.iterator().next().getTestDuration().values().iterator().next().iterator().next()
                != null);
  }

  @Test
  void build_string_list_map_class_domain_returns_expected_maps() throws Exception {
    Set<MapStringListTestDomain> test =
        FakerPojo.Builder.fromPojo(MapStringListTestDomain.class).toSet().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();
  ...
  void build_string_domain_map_class_domain_returns_expected_map() throws Exception {
    Set<MapStringDomainTestDomain> test =
        FakerPojo.Builder.fromPojo(MapStringDomainTestDomain.class).toSet().build();
    DefaultFakerFieldProps fieldAnnotation = new DefaultFakerFieldProps();

    assertTrue(
        test.iterator().next().getTestDomainMap().size() == fieldAnnotation.getRecords()
  ...
  void build_class_domain_with_unique_on_key_returns_expected_unique_domain() throws Exception {
    Set<ClassTestDomain> boolOne =
        FakerPojo.Builder.fromPojo(ClassTestDomain.class)
            .toSet()
            .withUniqueOnKey("testBoolean")
            .build();

    Set<ClassTestDomain> boolTwo =
        FakerPojo.Builder.fromPojo(ClassTestDomain.class)
            .toSet()
            .withUniqueOnKey("testBoolean")
            .build();
    ...
    assertEquals(
        boolOne.iterator().next().getTestBoolean(), !boolTwo.iterator().next().getTestBoolean());
    assertThrows(
  ...
  void build_record_domain_returns_expected_types() throws Exception {
    Set<RecordTestDomain> test = FakerPojo.Builder.fromPojo(RecordTestDomain.class).toSet().build();
  ...
  void build_list_domain_domain_returns_expected_list() throws Exception {
    Set<ListDomainTestDomain> test =
        FakerPojo.Builder.fromPojo(ListDomainTestDomain.class).toSet().build();

    assertTrue(
        test.iterator().next().getClassTestDomainList().size() == 1
  ...
  void build_list_record_domain_returns_expected_list() throws Exception {
    Set<ListRecordTestDomain> test =
        FakerPojo.Builder.fromPojo(ListRecordTestDomain.class).toSet().build();
  ...
  void build_list_map_domain_returns_expected_list() throws Exception {
    Set<ListMapTestDomain> test =
        FakerPojo.Builder.fromPojo(ListMapTestDomain.class).toSet().build();

    assertTrue(
        test.iterator().next().getMapStringDomainList().size() == 1
  ...
  void build_custom_field_annotation_class_domain_returns_expected_domain() throws Exception {
    Set<FieldAnnotationTestDomain> test =
        FakerPojo.Builder.fromPojo(FieldAnnotationTestDomain.class).toSet().build();
  ...
  void build_custom_value_generator_returns_expected_values() throws Exception {
    Set<CustomValueGeneratorTestDomain> test =
        FakerPojo.Builder.fromPojo(CustomValueGeneratorTestDomain.class).toSet().build();

    assertTrue(
        test.iterator().next().getTestEmployeeNumber() >= 20
            && test.iterator().next().getTestEmployeeNumber() <= 1200000);
    assertTrue(
        Integer.parseInt(test.iterator().next().getTestEmployeeNumberString()) >= 20
            && test.iterator().next().getTestEmployeeNumber() <= 1200000);
    assertEquals(
        NanoPrefix.type,
    ...
    assertEquals(
        NanoPrefix.project,
        NanoIdService.getPrefixFromValue(
            test.iterator().next().getTestNanoIdList().iterator().next().substring(0, 3)));
  }
}
