...
import survival1sm.fakerpojo.generators.DefaultValueGenerators;
import survival1sm.fakerpojo.generators.FieldValueGenerator;
import survival1sm.fakerpojo.service.FieldValueService;
import survival1sm.fakerpojo.service.PojoDataService;
...
public class FakerPojo {
  ...
  public static class Builder {
    ...
    public static class ClassBuilder<T> extends Builder implements survival1sm.fakerpojo.builders.ClassBuilder<T> {
      ...
      public static class DataBuilder<T> extends Builder implements
          survival1sm.fakerpojo.builders.DataBuilder<T> {
      ...
      public static class ListBuilder<T> extends Builder implements
          survival1sm.fakerpojo.builders.ListBuilder<T> {
      ...
      public static class SetBuilder<T> extends Builder implements
          survival1sm.fakerpojo.builders.SetBuilder<T> {
    ...
    public static class PojoBuilder<T> extends Builder implements
        survival1sm.fakerpojo.builders.PojoBuilder<T> {
      ...
      public static class MapBuilder<K, T> extends Builder
          implements survival1sm.fakerpojo.builders.MapBuilder<K, T> {
